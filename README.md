...
| Plugin               | What it adds                                                              |
| -------------------- | ------------------------------------------------------------------------- |
| `mrbavio.text`        | plain canvas text as an item kind: type, edit, resize, paste a paragraph. Needs Daydream 0.1.21 or later (decisions.md #71, the `styles` field) |
| `mrbavio.grid`        | a DevTools-style grid overlay for the selected grid container. Needs Daydream 0.1.21 or later (decisions.md #71, the `styles` field) |
| `mrbavio.notes`       | a notes pane in the dock, saved with the document. Needs Daydream 0.1.21 or later (decisions.md #71, the `styles` field) |
| `mrbavio.html-editor` | the selected element's subtree as HTML source, structure only. Needs Daydream 0.1.21 or later (decisions.md #71, the `styles` field) |
