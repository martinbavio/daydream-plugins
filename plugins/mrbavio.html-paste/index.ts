...
// kernel as every landing is (`dd.cleanPage`): what it removes cut out
// (an `<iframe>` stays, sandboxed at render), the `<style>` text folded
// into the css, the rest as the html, and one console line saying what
// the cleaning did. No panel, no command, no
// toast.
